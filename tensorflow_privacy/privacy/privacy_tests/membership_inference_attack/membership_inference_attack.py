...
# TODO(shuangsong): can we allow customized attacker?
def _run_trained_attack(attack_input: AttackInputData,
  ...
  return SingleAttackResult(
      ...
      membership_scores_train=scores[:attack_input.get_train_size()],
      membership_scores_test=scores[attack_input.get_train_size():],
      roc_curve=roc_curve)
